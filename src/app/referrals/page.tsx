    ...
    <section className="relative space-y-4 overflow-hidden px-8 pb-12 pt-8">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-8 pt-20">
        ...
        >
          ...
          />
          <path
            d="M114.406 108.48H77.9012L69.6933 99.6609L63.3223 108.48H26.8171C26.4498 108.492 26.0824 108.419 25.7272 108.285C25.3842 108.137 25.0777 107.93 24.8078 107.672C24.5521 107.402 24.343 107.096 24.2091 106.753C24.0609 106.397 24 106.03 24 105.663V80.0607L30.7384 71.8529L24 65.6036V40.7364C24 40.3691 24.0609 40.0017 24.2091 39.6465C24.343 39.3035 24.5521 38.997 24.8078 38.7271C25.0777 38.4714 25.3842 38.2623 25.7272 38.1162C26.0824 37.9802 26.4498 37.9193 26.8171 37.9193H63.3223L69.5715 43.9209L77.9012 37.9193H114.406C114.774 37.9193 115.153 37.9802 115.496 38.1162C115.839 38.2623 116.146 38.4714 116.416 38.7271C116.673 38.997 116.88 39.3035 117.029 39.6465C117.163 40.0017 117.236 40.3691 117.223 40.7364L117.102 65.6036L110.363 72.0964L117.102 80.0607L117.223 105.663C117.199 106.397 116.893 107.096 116.367 107.623C115.839 108.149 115.141 108.455 114.406 108.48Z"
            fill="#1570EF"
          />
          <path
            d="M117.102 65.6036H77.9012V37.9193H63.3223V65.6036H24V80.0607H63.3223V108.48H77.9012V80.0607H117.102V65.6036Z"
            fill="#FEC84B"
          />
          <circle cx="17" cy="117" r="3" fill="#12B76A" />
          <circle cx="5" cy="104" r="5" fill="#FFE58B" />
          <circle cx="137" cy="12" r="3" fill="#FD853A" />
        </svg>
      ...
      <div className="flex w-full items-center justify-between gap-3">
        <h4 className="text-base font-semibold">Friends invited</h4>
        <h6 className="text-sm font-normal text-[#AAAAAA]">
          Total invites: <span className="text-base font-bold">0</span>
        </h6>
      </div>
    </section>
  );
